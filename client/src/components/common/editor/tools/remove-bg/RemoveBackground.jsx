...
export function RemoveBackground({ imageUrl, setCroppedImageFor, onCancel }) {
    ...
    return (
        <div className="grid mt-20">
            ...
            <div className="mt-10">
                {/* <button className="" onClick={RemoveBg} disabled={isLoading}>Apply</button> */}

                <button type="button" onClick={RemoveBg}
